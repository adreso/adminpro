...
export class UsuarioService {
  ...
  loginGoogle(token: string){
    ...
    return this.http.post(url, {
      ...
      (resp:any) => {
        this.guardarStorege(resp.id, resp.token, resp.usuario);
        return true;
      }
    ));
    ...
    return this.http.put(url, usuario).pipe(map(
      (resp:any) => {
        if(usuario._id===this.usuario._id){
          this.guardarStorege(resp.usuario._id, this.token, resp.usuario);
        }
  ...
  cambiarImagen(archivo: File, id: string){
    ...
    .then((resp: any) =>{
      ...
      this.guardarStorege(id, this.token, this.usuario);
